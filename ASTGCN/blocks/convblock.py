...
class TemporalConv(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.conv = nn.Conv2d(
            ...
            dilation=(1, self.params.dialation)
        )
...
class SpatialConv(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.weight = nn.Parameter(torch.randn(size=params.w_sc_size))
        self.relu = nn.ReLU()
    ...
    def forward(self, x, spatial_attn):
            ...
            for k in range(self.polynomial_order):
                ...
                Pk = torch.tensor(self.cheb_polynomials[k], dtype=torch.float32) # (N, N)
